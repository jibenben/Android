...
//提示语
private String updateMsg = "请下载升级包";
//返回的安装包url
...
public UpdateManager(Context context,String string) {
...
public void run() {
		...
		file.mkdir();
			...
			saveFileName= local_file+"aaa.apk";
		String apkFile = local_file+"aaa.apk";
